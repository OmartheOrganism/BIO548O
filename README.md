...
The module will run from *November 4* to *December 2* 2021. Note that this differs slightly from the dates in the UBC Course calendar. There will be no classes during Reading Week.

Classes will be held in person in BRC224 on Tuesdays and Thursdays from 1500-1630.
